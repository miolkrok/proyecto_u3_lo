...
class TransferenciaServiceImplTest {
	...
	void testRealizarTransferencia() {
		...
		assertEquals(new BigDecimal(140).setScale(2), this.cuentaBancariaRepository.buscarPorNumero("58463").getSaldo());
	}
	...
	@Commit
	void testEliminar() {
		this.transferenciaService.eliminar(30);
		assertNull(this.transferenciaService.buscar(16));
	}
}
